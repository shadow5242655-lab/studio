...
/**
 * @fileOverview Spotify-style Mini Player with centered playback controls and red seek bar.
 */
...
export function NowPlayingBar() {
  ...
  return (
    <div className="bg-[#121212] border-t border-white/5 px-4 pt-3 pb-2 animate-in slide-in-from-bottom duration-500 relative select-none">
      <div className="max-w-7xl mx-auto flex flex-col gap-2">
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-4 shrink-0 pl-4">
             ...
             <button className="text-neutral-500 hover:text-white transition-colors" onClick={nextTrack}>
               <SkipForward className="h-5 w-5 fill-current" />
             </button>
             <button className="text-neutral-600 p-1 hover:text-primary transition-colors" onClick={(e) => { e.stopPropagation(); stopTrack(); }}>
               <X className="h-5 w-5" />
             </button>
          </div>
        </div>
