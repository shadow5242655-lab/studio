...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative py-20 md:py-32 bg-secondary/20">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            <div className="flex items-center gap-2 bg-card px-4 py-2 border rounded-full shadow-sm border-primary/20">
      ...
      {/* Availability Banner */}
      <section className="bg-primary py-4 text-white overflow-hidden relative">
        <div className="flex whitespace-nowrap animate-pulse">
          <p className="text-sm md:text-xl font-headline font-bold uppercase tracking-[0.2em] px-4 mx-auto">
      ...
      <section id="about" className="py-20 max-w-4xl mx-auto px-6">
        <div className="space-y-10 text-center">
          <h3 className="text-2xl md:text-3xl font-headline font-bold italic border-b-2 border-primary pb-4 inline-block">Heritage of Excellence</h3>
          <div className="space-y-6 text-base md:text-lg text-muted-foreground leading-relaxed text-left md:text-center">
            <p>
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-20 bg-secondary/30 border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h3 className="text-3xl font-headline font-bold italic text-primary">Patron Testimonials</h3>
            <p className="text-xs text-muted-foreground uppercase tracking-[0.2em] font-bold">Trusted by families for generations</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {reviews.map((review, i) => (
              <div key={i} className="bg-card p-8 border border-white/5 rounded-sm shadow-xl text-center hover:border-primary/30 transition-all duration-300">
                <div className="flex justify-center gap-1 mb-4">
                  {[...Array(review.rating)].map((_, j) => (
                    <Star key={j} className="h-3 w-3 fill-primary text-primary" />
                  ))}
                </div>
                <p className="italic text-muted-foreground mb-8 leading-relaxed text-sm">"{review.text}"</p>
                <div className="border-t border-white/5 pt-6">
                  <p className="font-bold text-xs tracking-wide uppercase">{review.name}</p>
      ...
      <section id="contact" className="py-20 max-w-4xl mx-auto px-6">
        <div className="bg-card border border-white/5 rounded-sm p-8 md:p-16 shadow-2xl space-y-12">
          <div className="text-center space-y-4">
            <h3 className="text-3xl md:text-5xl font-headline font-bold italic text-primary">Visit Our Store</h3>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-10">
            <div className="flex items-center gap-6 group">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-primary mt-1">+91 88403 66167</p>
              </div>
            </div>
            <div className="flex items-start gap-6 group">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl font-bold">Dakghar road, Mahewa Ganj, Choraha</p>
                <p className="text-xs font-medium text-muted-foreground">Lakhimpur, Uttar Pradesh 261506</p>
              </div>
            </div>
            <div className="flex items-center gap-6 group">
              <div className="h-12 w-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0 border border-primary/20">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl font-bold">10:00 AM - 9:00 PM</p>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-white/5 bg-secondary/50">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-8">
          <div className="space-y-2">
            <p className="text-2xl md:text-3xl font-headline font-bold text-primary uppercase tracking-tight">SHIV CLOTHES HOUSE AND GARMENTS</p>
            <p className="text-[10px] text-muted-foreground uppercase tracking-[0.5em] font-bold">
              Quality • Trust • Tradition
            </p>
          </div>
          <div className="pt-8 text-[10px] text-muted-foreground uppercase tracking-[0.3em] font-semibold border-t border-white/5 inline-block px-12">
