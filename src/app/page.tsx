    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative py-16 md:py-32 grey-gradient">
        <div className="max-w-4xl mx-auto px-6 text-center space-y-6 md:space-y-8">
          ...
          <h2 className="text-3xl md:text-7xl font-headline font-bold leading-tight uppercase tracking-tight">
      ...
      {/* About Section */}
      <section id="about" className="py-16 md:py-24 max-w-4xl mx-auto px-6">
        <div className="space-y-8 md:space-y-12 text-center">
          <h3 className="text-xl md:text-3xl font-headline font-bold italic border-b-2 border-primary pb-3 inline-block">Heritage of Excellence</h3>
          <div className="space-y-4 md:space-y-6 text-sm md:text-lg text-muted-foreground leading-relaxed text-left md:text-center">
            <p>
      ...
      {/* Reviews Section */}
      <section id="reviews" className="py-16 md:py-24 bg-card border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12 md:mb-16 space-y-3">
            <h3 className="text-2xl md:text-3xl font-headline font-bold italic text-primary">Patron Testimonials</h3>
            <p className="text-[10px] text-muted-foreground uppercase tracking-[0.2em] font-bold">Trusted by families for generations</p>
          </div>
          <div className="grid md:grid-cols-3 gap-6">
            {reviews.map((review, i) => (
              <div key={i} className="bg-background p-6 md:p-8 border border-white/5 rounded-sm shadow-xl text-center hover:border-primary/30 transition-all duration-300">
                ...
                <p className="italic text-muted-foreground mb-6 md:mb-8 leading-relaxed text-xs md:text-sm">"{review.text}"</p>
                <div className="border-t border-white/5 pt-6">
                  <p className="font-bold text-[10px] md:text-xs tracking-wide uppercase">{review.name}</p>
                  <p className="text-[9px] md:text-[10px] text-muted-foreground uppercase tracking-[0.2em] mt-1">{review.location}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 md:py-24 max-w-4xl mx-auto px-6">
        <div className="bg-card border border-white/5 rounded-sm p-8 md:p-16 shadow-2xl space-y-10 md:space-y-12">
          <div className="text-center space-y-3">
            <h3 className="text-2xl md:text-5xl font-headline font-bold italic text-primary">Visit Our Store</h3>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10">
            <div className="flex items-center gap-4 md:gap-6 group">
              <div className="h-10 w-10 md:h-12 md:w-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0 border border-primary/20">
                <Phone className="h-4 w-4 md:h-5 md:h-5 text-primary" />
              </div>
              <div>
                <p className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-1">Call Us</p>
            ...
            <div className="flex items-center gap-4 md:gap-6 group">
              ...
              <div>
                <p className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-1">Shop Hours</p>
                <p className="text-base md:text-xl font-bold">10:00 AM - 9:00 PM</p>
                <p className="text-[8px] md:text-[10px] text-muted-foreground italic font-medium uppercase tracking-widest mt-1">Open All Days</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Footer */}
      <footer className="py-10 md:py-12 border-t border-white/5 bg-card">
        <div className="max-w-7xl mx-auto px-6 text-center space-y-6 md:space-y-8">
          <div className="space-y-2">
            <p className="text-xl md:text-3xl font-headline font-bold text-primary uppercase tracking-tight">SHIV CLOTHES HOUSE AND GARMENTS</p>
            <p className="text-[8px] md:text-[10px] text-muted-foreground uppercase tracking-[0.5em] font-bold">
              Quality • Trust • Tradition
            </p>
          </div>
          <div className="pt-6 md:pt-8 text-[8px] md:text-[10px] text-muted-foreground uppercase tracking-[0.3em] font-semibold border-t border-white/5 inline-block px-8 md:px-12">
